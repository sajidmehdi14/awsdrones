...
instances = ec2.create_instances(ImageId=img[0].id, MinCount=1, MaxCount=1, InstanceType='t2.micro', KeyName=key.key_name)
...
sg.authorize_ingress(IpPermissions=[{'FromPort': 22, 'ToPort': 22, 'IpProtocol': 'TCP', 'IpRanges': [{'CidrIp': '42.201.208.125/32'}]}])
...
sg.authorize_ingress(IpPermissions=[{'FromPort': 80, 'ToPort': 80, 'IpProtocol': 'TCP', 'UserIdGroupPairs': [{'GroupId': 'sg-2a10ad4c'}]}])
